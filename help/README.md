...
#### 費用・手数料について
アカウント作成や決済機能の導入に対して手数料は発生しません。無料でご利用いただけます。PAY.JPを経由して売上が発生した際に、決済手数料が発生いたします。手数料は、VISAカード、MASTERカードについては、3.0%、JCB, AMEX , Diners , Discoverについては3.6%となります。なお、初年度（2015年9月7日から2016年5月31日）についてはキャンペーン期間中につき、月額1,000万円以下のトランザクションに対しては、決済手数料無料でご提供させていただきます。
