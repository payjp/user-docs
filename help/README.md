...
## 本番申請審査のポイント
本番申請の際には、審査の前に入力情報のチェックをさせていただいてからクレジットカード会社の審査を行っていますが、前段の段階における入力情報の修正に多く時間がかかっているケースがございます。  申請情報のチェックを最速で通過させるために、「特定商取引法に基づく表記」「商品情報」「その他の情報」についてチェックポイントを記載いたします。
...
#### プライバシーポリシー
審査する段階で、プライバシーポリシーが必要です。    もし、現在、BASEショップのお客様がPAY.JPにお申し込みいただく場合は、独自のプライバシーポリシーが必要になるので、ご注意ください。（なおBASEショップからはPAY.JP決済はお使いいただけないことにご注意ください）
