...
ヘルプページは、Githubから [PAY.JP ヘルプ](http://help.pay.jp) へ移行されました。 

このドキュメントは2016/1/25をもって、今後アップデートを行いませんのでご注意ください。　

以降ヘルプやFAQについては [PAY.JP ヘルプ](http://help.pay.jp) でご確認ください。
...
#### パスワード管理
PAY.JP管理画面へのパスワードは慎重な管理を行い、定期的に見直し・変更を行うようにしてください。必ず、他のウェブサイトとは違うパスワードをご登録いただくようお願い致します。また、直近の過去4回の間に使用したパスワードと同じものには変更できないので、ご注意ください。
...
### 商品の価格帯について
PAY.JP申請内容に商品の販売価格帯という欄がございますが、ここにアバウトな価格範囲を記述すると、審査の段階で商品価格との整合性を問われるため、その分の確認、やりとりが発生し審査の進行が遅れます。販売価格帯は、審査に重要なパラメータになっておりますので商品単価との整合を取っていただくようにお願いします。後日、価格帯よりも高額な商品を売る場合は、事前に商品情報と共に再申請いただくようお願い致します。（想定外の高額決済は、契約解除の対象になりますのでご注意ください。）
...
#### 商品代金以外の必要料金
商品代金以外に購入者がかかる料金をすべて記載ください。

また銀行振込手数料、税金以外の費目については、項目と金額をご記載ください。
Ex)送料○円、代引き手数料○円、コンビニ手数料○円、加工費○円等

この部分の記載で、クレジットカードの手数料を購入者が負担するような表現はNGになります。誤解される表現は修正のお願いをさせていただくことになります。
...
また、返品を受け付けないビジネスの場合は、不良品等に関する記載をご考慮ください。

利用者の環境不備により不良品かどうか判断できない場合に、利用者を突き放すことなく、問い合わせを受け付けるなどの姿勢を表現することが必要になります。
